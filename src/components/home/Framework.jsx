  ...
  return (
    <section className='lg:py-[65px] py-10 text-white px-4'>
      <div className='max-w-[1000px] mx-auto'>
        <h3 className='lg:text-3xl md:text-2xl text-xl text-center max-w-[767px] mx-auto'>
          Transfrom work practices forever. <br />
          Our Framework for the futhure
        </h3>
              ...
              return (
                ...
                >
                  <div className={`rounded-3xl bg-jet h-full grid items-center md:grid-cols-2 
                      ...
                      ${frameworkGridSettings.cardGradientAfter} ${frameworkGridSettings.cardGradientBefore}
                       `}   
                    >
